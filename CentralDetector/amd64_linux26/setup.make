...
use OpticksG4OK v0 Externals (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J20v2r0-Pre2/ExternalInterface)
use Xercesc v0 Externals (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J20v2r0-Pre2/ExternalInterface)
use CLHEP v0 Externals (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J20v2r0-Pre2/ExternalInterface)
use Geant4 v0 Externals (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J20v2r0-Pre2/ExternalInterface)
use DetSimPolicy v0 Simulation/DetSimV2 (/home/huyuxiang/trunk/offline)
use ROOT v0 Externals (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J20v2r0-Pre2/ExternalInterface)
use Python v0 Externals (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J20v2r0-Pre2/ExternalInterface)
use Boost v0 Externals (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J20v2r0-Pre2/ExternalInterface)
use SniperPolicy v0  (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J20v2r0-Pre2/sniper)
use SniperKernel v2  (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J20v2r0-Pre2/sniper)
use Identifier v0 Detector (/home/huyuxiang/trunk/offline)
use Geometry v0 Detector (/home/huyuxiang/trunk/offline)
use G4Svc v0 Simulation/DetSimV2 (/home/huyuxiang/trunk/offline)
use RootWriter v0 SniperSvc (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J20v2r0-Pre2/sniper)
use DummyAlg v0 Examples (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J20v2r0-Pre2/sniper)
use PyDataStore v0 SniperUtil (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J20v2r0-Pre2/sniper)
use HelloWorld v1 Examples (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J20v2r0-Pre2/sniper)
use DataBuffer v0 SniperUtil (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J20v2r0-Pre2/sniper)
use SniperRelease v2  (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J20v2r0-Pre2/sniper)
use DetSimAlg v0 Simulation/DetSimV2 (/home/huyuxiang/trunk/offline)
----------> tags
...
----------> CMTPATH
# Add path /home/huyuxiang/trunk/offline from initialization
# Add path /cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J20v2r0-Pre2/mt.sniper from initialization
# Add path /cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J20v2r0-Pre2/sniper from ProjectPath
# Add path /cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J20v2r0-Pre2/ExternalInterface from ProjectPath
