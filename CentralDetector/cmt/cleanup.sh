...
${CMTROOT}/mgr/cmt cleanup -sh -pack=CentralDetector -version=v0 -path=/home/huyuxiang/trunk/offline/Simulation/DetSimV2  $* >${cmtCentralDetectortempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/mgr/cmt cleanup -sh -pack=CentralDetector -version=v0 -path=/home/huyuxiang/trunk/offline/Simulation/DetSimV2  $* >${cmtCentralDetectortempfile}"
  cmtcleanupstatus=2
